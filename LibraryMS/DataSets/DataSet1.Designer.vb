...
Partial Public Class DataSet1
    ...
    Partial Public Class usertblDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddusertblRow(ByVal Fname As String, ByVal Lname As String, ByVal username As String, ByVal pass As String, ByVal role As String, ByVal status As String) As usertblRow
            Dim rowusertblRow As usertblRow = CType(Me.NewRow,usertblRow)
            Dim columnValuesArray() As Object = New Object() {Fname, Lname, username, pass, role, status}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindByFname(ByVal Fname As String) As usertblRow
            Return CType(Me.Rows.Find(New Object() {Fname}),usertblRow)
        End Function
    ...
    Partial Public Class usertblRow
        ...
        Public Property Fname() As String
            Get
                Return CType(Me(Me.tableusertbl.FnameColumn),String)
            End Get
            Set
                Me(Me.tableusertbl.FnameColumn) = value
            End Set
        End Property
        ...
        Public Property Lname() As String
            Get
                Return CType(Me(Me.tableusertbl.LnameColumn),String)
            End Get
            Set
                Me(Me.tableusertbl.LnameColumn) = value
            End Set
        End Property
        ...
        Public Property pass() As String
            Get
                Return CType(Me(Me.tableusertbl.passColumn),String)
            End Get
            Set
                Me(Me.tableusertbl.passColumn) = value
            End Set
        End Property
        ...
        Public Property role() As String
            Get
                Return CType(Me(Me.tableusertbl.roleColumn),String)
            End Get
            Set
                Me(Me.tableusertbl.roleColumn) = value
            End Set
        End Property
        ...
        Public Property status() As String
            Get
                Return CType(Me(Me.tableusertbl.statusColumn),String)
            End Get
            Set
                Me(Me.tableusertbl.statusColumn) = value
            End Set
        End Property
    End Class
...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class usertblTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `usertbl` WHERE ((`Fname` = @p1) AND (`Lname` = @p2) AND (`pass` = @p"& _ 
                "3) AND (`username` = @p4) AND (`role` = @p5) AND (`status` = @p6))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `usertbl` (`Fname`, `Lname`, `pass`, `username`, `role`, `status`) VA"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `usertbl` SET `Fname` = @p1, `Lname` = @p2, `pass` = @p3, `username` = @p4"& _ 
                ", `role` = @p5, `status` = @p6 WHERE ((`Fname` = @p7) AND (`Lname` = @p8) AND (`"& _ 
                "pass` = @p9) AND (`username` = @p10) AND (`role` = @p11) AND (`status` = @p12))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Fname, Lname, pass, username, role, status"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            usertbl"& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (status = 'active')"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet1.usertblDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSet1.usertblDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet1.usertblDataTable = New DataSet1.usertblDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DataSet1.usertblDataTable) As Integer
